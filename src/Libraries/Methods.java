...
import DatabaseMechanic.DatabaseMainGUIVariables;
...
import static DatabaseMechanic.DatabaseGameMechanic.colorful_string;
import static GameMechanic.GameMainVariables.labelSaveAccount;
import static GameMechanic.GameMainVariables.labelWarning;
...
public abstract class Methods {
    ...
    public static void printNote(String note, int type) {
        switch (type) {
            ...
            case NOTE_TYPE_ERROR:
                if (colorful_string) {
                    System.out.println("<" + DEFAULT_NOTE_SENDER + ">" + ANSI_RED + " -ERROR- " + ANSI_RESET + note);
                } else {
                    System.out.println("<" + DEFAULT_NOTE_SENDER + "> -ERROR- " + note);
                }
                break;
            case NOTE_TYPE_INFO:
